...
async function main() {
  ...
  const userSeeds: UserSeed[] = [
    {
      name: "高負荷 耐子",
      password: "$2b$10$Nyc6vwf9Ovqi8lmZIHz7IO2qHLhlGgNbjb8CdtzZ4OVvqnBdUKmCK",  // password1111
      email: "admin01@example.com",
      role: Role.ADMIN,
    },
    {
      name: "不具合 直志",
      password: "$2b$10$CxUr.PvDQpblp/bDznY9ouvSzzSqEUwwirTVmSID5LwDDyOh2kXLS",  // password2222
      email: "admin02@example.com",
      role: Role.ADMIN,
    },
    {
      name: "構文 誤次郎",
      password: "$2b$10$YGMuOB8zVKjwTBQnhPukvu/KYkLdp8qyQDxSiKaS5K5dea6Y3d72m",  //password1111
    ...
    {
      name: "仕様 曖昧子",
      password: "$2b$10$Cwikw2nmlP1uG.AM6qxIKOwXbPYOoMIwUasPg4euzezBd6fCiw52C",  // password2222
